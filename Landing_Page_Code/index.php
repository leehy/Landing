...
<html lang="en">
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-custom navbar-fixed-top top-nav-collapse col-sm-12"  role="navigation">
            <div class="container">
            ...
            <div id="img-video">
                <div class="container height-full">
                    <div class="row text-center">
                        <div class="col-md-8 col-md-offset-2 padding-top-10 col-sm-8 col-sm-offset-2">
        ...
        <section id="info" class="content-section text-center">
            ...
            <div class="col-md-10">
            <h2> Our Kickstarter campaign is coming soon, follow us and let's make this project a reality ! </h2>
            </div>
            <div class="col-md-1"></div>
        </section>
